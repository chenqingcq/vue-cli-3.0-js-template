    ...
    <template v-if="currentIndex == 0 ">
        ...
        <div class="item">
          ...
          <div class="groups center" v-if="getAgencyType == 3">
            ...
            <el-select
              ...
              style="width:160px;height:28px;border:none;margin-right:15px;"
      ...
      <div class="content">
        ...
        >
          ...
          <el-table-column prop="visitorName" :label="$t('personnel.staff.name')" width="160"></el-table-column>
          <el-table-column :label="$t('personnel.staff.group')" width="160">
          ...
          <el-table-column :label="$t('personnel.staff.deadLine')">
            <template
              slot-scope="scope"
